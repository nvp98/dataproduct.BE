...
public partial class ProductFormContextTmp : DbContext
{
    public ProductFormContextTmp()
    {
    }

    public ProductFormContextTmp(DbContextOptions<ProductFormContextTmp> options)
        : base(options)
    {
    }
