...
public partial class ProductFormContextTmp2 : DbContext
{
    public ProductFormContextTmp2()
    {
    }

    public ProductFormContextTmp2(DbContextOptions<ProductFormContextTmp2> options)
        : base(options)
    {
    }
