...
namespace dataproduct.api.Controllers
{
    ...
    public class Hrc1SlabController : ControllerBase
    {
        ...
        public async Task<IActionResult> XacNhan([FromBody] XacNhanRequest request)
        {
            ...
            if (request.LoaiXacNhan != "Duc" && request.LoaiXacNhan != "Can" && request.LoaiXacNhan != "C4" && request.LoaiXacNhan != "PKH")
                return BadRequest("LoaiXacNhan phải là 'Duc', 'Can', 'C4' hoặc 'PKH'.");
