...
namespace dataproduct.api.Services.Exporters
{
    ...
    /// </summary>
    public class HRC1_BBXNSLPhoiThepExcelExporter : IPhieuExcelExporter
    {
        private readonly BBXNSLPhoiThepService _service;

        public HRC1_BBXNSLPhoiThepExcelExporter(BBXNSLPhoiThepService service)
        {
            _service = service;
        }
